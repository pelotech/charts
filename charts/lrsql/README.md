...
| httpRoute.gateway.group | string | `"gateway.networking.k8s.io"` |  |
| httpRoute.gateway.kind | string | `"Gateway"` |  |
| httpRoute.gateway.name | string | `""` |  |
| httpRoute.gateway.namespace | string | `""` |  |
| httpRoute.gateway.port | string | `nil` |  |
| httpRoute.gateway.sectionName | string | `""` |  |
| httpRoute.hostname | string | `""` |  |
| httpRoute.listenerSet.annotations | object | `{}` |  |
| httpRoute.listenerSet.enabled | bool | `false` |  |
| httpRoute.listenerSet.https.enabled | bool | `false` |  |
| httpRoute.listenerSet.https.secretName | string | `""` |  |
| httpRoute.listenerSet.listeners | list | `[]` |  |

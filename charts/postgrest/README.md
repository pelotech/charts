...
| application.preRequest | string | `"realm.access"` |  |
...
| cluster.cluster.roles[1].name | string | `"opendash"` |  |
| cluster.cluster.roles[2].ensure | string | `"present"` |  |
| cluster.cluster.roles[2].login | bool | `false` |  |
| cluster.cluster.roles[2].name | string | `"anon"` |  |
| cluster.cluster.roles[3].ensure | string | `"present"` |  |
| cluster.cluster.roles[3].login | bool | `false` |  |
| cluster.cluster.roles[3].name | string | `"peek"` |  |
| cluster.cluster.roles[4].ensure | string | `"present"` |  |
| cluster.cluster.roles[4].login | bool | `false` |  |
| cluster.cluster.roles[4].name | string | `"view"` |  |
| cluster.cluster.roles[5].ensure | string | `"present"` |  |
| cluster.cluster.roles[5].login | bool | `false` |  |
| cluster.cluster.roles[5].name | string | `"edit"` |  |
| cluster.cluster.roles[6].ensure | string | `"present"` |  |
| cluster.cluster.roles[6].inRoles[0] | string | `"opendash"` |  |
| cluster.cluster.roles[6].inRoles[1] | string | `"anon"` |  |
| cluster.cluster.roles[6].inRoles[2] | string | `"peek"` |  |
| cluster.cluster.roles[6].inRoles[3] | string | `"view"` |  |
| cluster.cluster.roles[6].inRoles[4] | string | `"edit"` |  |
| cluster.cluster.roles[6].login | bool | `true` |  |
| cluster.cluster.roles[6].name | string | `"postgrest"` |  |
| cluster.cluster.roles[6].passwordSecret.name | string | `"connection"` |  |

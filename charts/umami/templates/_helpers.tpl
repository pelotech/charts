...
{{/*
Return the proper umami image name
*/}}
{{- define "umami.image" -}}
...
{{/*
Return the proper umami SSO image name
*/}}
{{- define "umami.sso.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.sso.image "global" .Values.global) }}
{{- end -}}

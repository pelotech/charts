...
{{/*
Create service name and version as used by the chart label.
*/}}
{{- define "mutating-webhook.svc" -}}
{{- printf "%s.%s.svc" (include "mutating-webhook.fullname" .) .Release.Namespace -}}
{{- end -}}
